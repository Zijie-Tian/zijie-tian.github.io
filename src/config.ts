...
export const siteConfig: SiteConfig = {
	title: "Zijie Tian's Blog",
	subtitle: "Personal Blog & Tech Notes",
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/zijie-tian", // Internal links should not include the base path, as it is automatically added
